...
int search(user user)
{
    ...
    searchB.addOption(" 2 > Back");
    searchB.addOption(" 3 > Update Status ");
    ...
    while (1)
    {
        ...
        if (displayB == "")
        {
            ...
            tmpS << setw(5) << "User ID | " << setw(12) << "Pet ID | "<< setw(11) << " Vaccine ID | " << setw(13) << " Vaccine Date | " << setw(14) << " Vaccine Date  | " << setw(8) << "Pet Name | " << setw(13) << " User Name  | " << setw(13) << " Vaccine Date | " << endl;

            for (int i = 0; i < vaccinations.size(); i++)
            {
                tmpS << setw(15) << vaccinations[i].user_id << " |" << setw(12)  << vaccinations[i].pet_id << " |" << setw(11) << vaccinations[i].vaccine_id << " |" << setw(15) << vaccinations[i].vaccine_name << " |" << setw(7) << vaccinations[i].pet_name << " |" << setw(15) << vaccinations[i].user_name << " |" << setw(14) << vaccinations[i].vaccine_date << " |" << endl;
            }
            displayB += tmpS.str();
